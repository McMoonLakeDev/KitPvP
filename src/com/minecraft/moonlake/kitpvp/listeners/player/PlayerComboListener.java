...
public class PlayerComboListener implements Listener {
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if(event.getAction() == Action.LEFT_CLICK_AIR || event.getAction() == Action.LEFT_CLICK_BLOCK) {
            ...
            if(kitPvPPlayer.getSkillCombo().getComboIndex() == 0 && !kitPvPPlayer.getOccupa().checkComboFirst(SkillComboType.LEFT)) {
            ...
            if(kitPvPPlayer.getSkillCombo().getComboIndex() == 0 && !kitPvPPlayer.getOccupa().checkComboFirst(SkillComboType.RIGHT)) {
